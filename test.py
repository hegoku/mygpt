...
embedding_layer = torch.nn.Embedding(tokenizer.len(), 20, dtype=torch.bfloat16)
...
print(mask.shape)
attention = Attention.CausalAttention(token_embedding.shape[0], token_embedding.shape[1], d_q=2, d_v=4, dropout=0.5).to(dtype=torch.bfloat16)
